...
#include <algorithm>
#include <limits>
#include <zqrdecode/pdf417/detector/Detector.h>
#include <zqrdecode/pdf417/detector/LinesSampler.h>
#include <zqrdecode/common/GridSampler.h>
#include <zqrdecode/common/detector/JavaMath.h>
#include <zqrdecode/common/detector/MathUtils.h>

using std::max;
using std::abs;
using std::numeric_limits;
using zqrdecode::pdf417::detector::Detector;
using zqrdecode::common::detector::Math;
