...
using zqrdecode::DecodeHintType;
...
#ifndef Q_CC_MSVC
const zqrdecode::DecodeHintType DecodeHints::CHARACTER_SET;
#endif // Q_CC_MSVC

const zqrdecode::DecodeHints DecodeHints::PRODUCT_HINT(
  UPC_A_HINT |
  UPC_E_HINT |
  EAN_13_HINT |
  EAN_8_HINT |
...
const zqrdecode::DecodeHints DecodeHints::ONED_HINT(
  CODE_39_HINT |
  CODE_93_HINT |
  CODE_128_HINT |
  ITF_HINT |
...
const zqrdecode::DecodeHints DecodeHints::DEFAULT_HINT(
  ONED_HINT |
  QR_CODE_HINT |
  DATA_MATRIX_HINT |
  AZTEC_HINT |
...
zqrdecode::DecodeHints zqrdecode::operator | (DecodeHints const& l, DecodeHints const& r) {
