...
QZqrDecode::QZqrDecode(QObject *parent) : QObject(parent)
{
...
QZqrDecode::QZqrDecode(QZqrDecode::DecoderFormat decodeHints, QObject *parent) : QObject(parent)
{
    decoder = new MultiFormatReader();
    imageHandler = new ImageHandler();
...
QString QZqrDecode::decoderFormatToString(int fmt)
{
    switch (fmt) {
      case 1:
          return "AZTEC";
...
QString QZqrDecode::foundedFormat() const
{
    return foundedFmt;
}

QString QZqrDecode::charSet() const
{
    return charSet_;
}

void QZqrDecode::setDecoder(const uint &hint)
{
...
QString QZqrDecode::decodeImage(QImage &image, int maxWidth, int maxHeight, bool smoothTransformation)
{
    QTime t;
    t.start();
    Ref<Result> res;
...
QString QZqrDecode::decodeImageFromFile(const QString& imageFilePath, int maxWidth, int maxHeight, bool smoothTransformation)
{
...
QString QZqrDecode::decodeImageQML(QObject *item)
{
    return decodeSubImageQML(item);
}

QString QZqrDecode::decodeSubImageQML(QObject *item,
...
QString QZqrDecode::decodeImageQML(const QUrl &imageUrl)
{
    return decodeSubImageQML(imageUrl);
}

QString QZqrDecode::decodeSubImageQML(const QUrl &imageUrl,
                                  const double offsetX, const double offsetY,
                                  const double width, const double height)
{
...
int QZqrDecode::getProcessTimeOfLastDecoding()
{
    return processingTime;
}

uint QZqrDecode::getEnabledFormats() const
{
